...
export const ko: SiteContent = {
  ...
  brands: {
    eyebrow: 'Brands',
    title: '직접 만든 브랜드로 증명합니다',
    body: '제형 개발부터 브랜딩, 패키지 디자인, 제조와 출고까지\n하나의 흐름으로 완성한 브랜드를 소개합니다.',
    scopeLabel: '담당 범위',
    skuLabel: 'SKU',
    yearLabel: '연도',
    productsLabel: '제품',
    ...
    entries: [
      {
        ...
        kind: '자사 브랜드 · 스킨케어',
        summary:
          '밤과 아침 사이의 시간을 컨셉으로 한 스킨케어 브랜드입니다.\n기획과 제형 설계부터 용기·단상자 디자인, 상세페이지, 생산까지\n외주로 나누지 않고 사내에서 완성했습니다.',
        scope: ['브랜드 기획', '제형 개발', '패키지 디자인', '상세페이지', '제조 · 출고'],
        skuLabel: '4종',
        products: [
          {
            slug: 'recovery-cream',
            ...
            claim: '밤사이 시작된 피부의 편안한 상태를 오래 이어지도록',
            tags: ['보습', '진정', '나이트 케어'],
            slices: 11,
          },
          {
            ...
            claim: '이데베논 항산화 케어로 시작하는 밀도 부스터',
            tags: ['항산화', '탄력', '보습'],
            slices: 7,
          },
          {
            ...
            claim: '나이아신아마이드와 씨벅턴 오일을 담은 톤 부스터',
            tags: ['항산화', '탄력', '보습'],
            slices: 12,
          },
          {
            ...
            claim: '한 번의 분사로 수분과 오일의 균형을 더하는 미스트',
            tags: ['수분', '오일 밸런스', '데일리'],
            slices: 9,
          },
        ],
